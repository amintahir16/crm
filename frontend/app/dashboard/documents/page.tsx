...
export default function DocumentsPage() {
  ...
  const filteredDocuments = documents.filter(document => {
    const matchesSearch = 
      ...
      document.customer?.fullName.toLowerCase().includes(searchTerm.toLowerCase()) ||
      document.plot?.plotNumber.toLowerCase().includes(searchTerm.toLowerCase()) ||
      document.constructionProject?.projectName.toLowerCase().includes(searchTerm.toLowerCase());
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Manage and organize all documents</p>
        </div>
        <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <div>
            ...
            >
              ...
              <option value="booking_document">Booking Document</option>
              <option value="plot_document">Plot Document</option>
              <option value="construction_document">Construction Document</option>
                  ...
                  <tr key={document.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-2">
                        <button
                          onClick={() => router.push(`/dashboard/documents/view/${document.id}`)}
                        ...
                        <button
                          onClick={() => router.push(`/dashboard/documents/edit/${document.id}`)}
